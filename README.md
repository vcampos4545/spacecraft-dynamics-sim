...
| [`cubesat_pyramid`](examples/cubesat_pyramid/)                | Same as `cubesat`, but with a 4-wheel pyramid RWA (tolerates a single wheel failure) via a proper least-norm pseudoinverse allocation, drawn as a wireframe body + flat-cylinder wheels |
